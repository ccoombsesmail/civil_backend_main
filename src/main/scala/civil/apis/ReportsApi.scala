...
import civil.models.{AppError, Report, ReportInfo}
...
object ReportsApi {
  val newReportEndpoint: Endpoint[(String, String, Report), AppError, Unit, Any] =
    baseEndpointAuthenticated.post
      .in("reports")
      .in(jsonBody[Report])

  val getReportEndpoint: Endpoint[(String, String, UUID), AppError, ReportInfo, Any] =
