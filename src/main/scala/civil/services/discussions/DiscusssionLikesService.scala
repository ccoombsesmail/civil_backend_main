...
import civil.models.NotifcationEvents.{GivingUserNotificationData, DiscussionLike}
...
case class DiscussionLikesServiceLive(discussionLikesRep: DiscussionLikesRepository, authenticationService: AuthenticationService)
...
object DiscussionLikesServiceLive {
  ...
  val layer: URLayer[DiscussionLikesRepository with AuthenticationService, DiscussionLikesService] = ZLayer.fromFunction(DiscussionLikesServiceLive.apply _)
