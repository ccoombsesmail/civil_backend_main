...
case class SpaceLikesServiceLive(
    spaceLikesRep: SpaceLikesRepository,
...
object SpaceLikesServiceLive {
  ...
  val layer: URLayer[
    SpaceLikesRepository with AuthenticationService,
    SpaceLikesService
  ] = ZLayer.fromFunction(SpaceLikesServiceLive.apply _)
