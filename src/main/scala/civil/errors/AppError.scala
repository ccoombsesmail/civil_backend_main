...
object AppError {
  ...
  final case class InternalServerError(userMsg: String) extends AppError

  final case class GeneralError(userMsg: String) extends AppError
  final case class Unauthorized(userMsg: String) extends AppError
